...
def launch_setup(context, *args, **kwargs):
    ...
    node_parameters = {
        ...
        'plane_half_extent': 1.0, # Not used in baseline planner
        'plane_spatial_resolution': 0.1, # Not used in baseline planner
        'cap_max_theta_deg': 60.0, # Not used in baseline planner
        'cap_min_theta_deg': 15.0, # Not used in baseline planner
